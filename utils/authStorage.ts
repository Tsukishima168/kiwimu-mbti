...
export type PassportLoginUiPresentation = 'screen' | 'popup' | 'redirect';
...
export interface PassportLoginUiOptions {
  presentation?: PassportLoginUiPresentation;
...
export function openPassportLogin(options: OpenPassportLoginOptions = {}): boolean {
  ...
  const sourceSite = options.sourceSite || 'kiwimu';
