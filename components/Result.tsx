            ...
            <div className="max-w-4xl mx-auto px-6 text-center">
              ...
              <div className="mt-6 flex flex-col items-center gap-3">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#5865F2] hover:bg-[#4752C4] text-white text-xs md:text-sm font-bold tracking-wider uppercase transition-all shadow-lg hover:shadow-xl hover:scale-105 active:scale-95"
                >
