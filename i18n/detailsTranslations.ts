...
export const detailsTranslations: Record<string, Record<'en' | 'ja' | 'ko', DetailsTranslation>> = {
    INTJ: {
        en: {
            keywords: ["Vision", "Independent", "Strategy", "Perfection"],
    ...
    INTP: {
        en: {
            keywords: ["Curiosity", "Logic", "Deconstruct", "Truth"],
    ...
    ENTJ: {
        en: {
            keywords: ["Ambition", "Strategy", "Decisive", "Power"],
    ...
    ENTP: {
        en: {
            keywords: ["Wit", "Challenge", "Innovation", "Versatile"],
    ...
    INFJ: {
        en: {
            keywords: ["Insight", "Idealism", "Mystery", "Altruism"],
    ...
    INFP: {
        en: {
            keywords: ["Dreamy", "Sincere", "Empathy", "Freedom"],
    ...
    ENFJ: {
        en: {
            keywords: ["Passion", "Leadership", "Altruism", "Influence"],
    ...
    ENFP: {
        en: {
            keywords: ["Energy", "Creativity", "Connection", "Freedom"],
    ...
    ISTJ: {
        en: {
            keywords: ["Duty", "Order", "Precision", "Tradition"],
    ...
    ISFJ: {
        en: {
            keywords: ["Guardian", "Patience", "Warmth", "Devotion"],
    ...
    ESTJ: {
        en: {
            keywords: ["Command", "Efficiency", "Iron Will", "Discipline"],
    ...
    ESFJ: {
        en: {
            keywords: ["Loyalty", "Harmony", "Service", "Warmth"],
    ...
    ISTP: {
        en: {
            keywords: ["Hands-on", "Cool", "Freedom", "Pragmatic"],
    ...
    ISFP: {
        en: {
            keywords: ["Aesthetic", "Gentle", "Present", "Authentic"],
    ...
    ESTP: {
        en: {
            keywords: ["Action", "Daring", "Thrill", "Charisma"],
    ...
    ESFP: {
        en: {
            keywords: ["Showman", "Joy", "Energy", "Present"],
